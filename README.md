...
- использование Intrinsics func
- улучшение производительности программы пр помощи XMM и YMM регистров (причём без вставок ассемблерного кода)
- использование SFML для рисования множества Мандельброта
- измерение времени программы для оценки производительности программы
...
По неизвестной нам причине во второй версии произошло ухудшение качества.  
Ниже приведены изображения множества Мандельброта:

Картинка в первой версии:

![первая картинка](pictures/mandelbrod_2.png)

Картинка во второй версии:

![вторая картинка](pictures/mandelbrod_3.png)
